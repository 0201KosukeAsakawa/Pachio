...
void UPlayerInputComponent::BindInput(UInputComponent* PlayerInputComponent )
{
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// カラーモード操作
		EnhancedInputComponent->BindAction(IncreaseColorAction, ETriggerEvent::Triggered, PlayerCharacter, &APlayerCharacter::DecreaseColor);
		EnhancedInputComponent->BindAction(DecreaseColorAction, ETriggerEvent::Triggered, PlayerCharacter, &APlayerCharacter::IncreaseColor);
